...
export function Footer() {
  ...
  return (
    ...
    >
      ...
      {/* Bottom bar */}
      <div className="container-custom py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sage-400 text-sm">
